...
public class BoardController {
    ...
    public ResponseEntity<?> list(@ModelAttribute BoardListSearch_InDTO boardListSearchInDTO,
        ...
        return ResponseEntity.ok()
                .body(new ResponseDTO<>().data(boardService.findAll(boardListSearchInDTO, adjustedPageable)));
    }
    ...
    public ResponseEntity<?> save(@RequestBody @Valid BoardSave_InDTO boardSaveInDTO,
        ...
        return ResponseEntity.ok()
                .body(new ResponseDTO<>().data(boardService.save(boardSaveInDTO, myUserDetails.getUser().getId())));
    }
    ...
    public ResponseEntity<?> updateForm(@PathVariable Long boardId,
        ...
        return ResponseEntity.ok()
                .body(new ResponseDTO<>().data(boardService.updateForm(boardId, myUserDetails.getUser().getId())));
    }

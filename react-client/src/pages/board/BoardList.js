      ...
      <div className="custom-board-list-container mb-5 mt-5">
        <div className="mb-3">
          <div className="custom-top-layout">
            <div className="custom-flex-item number">
              <span>번호</span>
            </div>
            <div className="custom-flex-item title">
              <span>제목</span>
            </div>
            <div className="custom-flex-item author">
              <span>글쓴이</span>
            </div>
            <div className="custom-flex-item date">
              <span>작성일</span>
            </div>
            <div className="custom-flex-item view">
              <span>조회</span>
            </div>
          </div>
          {/* 게시글 목록 */}
